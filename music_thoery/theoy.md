...
An equal temperament is a musical temperament or tuning system that approximates just intervals by dividing an octave (or other interval) into equal steps.
...
For example, an F with a double sharp F𝄪 applied raises it a whole step so it is enharmonically equivalent to a G. Das Doppelkreuz (Doppelkreuz) bezeichnet in der Musik die Erhöhung eines Stammtones um zwei Halbtöne. An den Tonnamen des nichtalterierten Tons wird die Endung -isis angehängt (z. B. C → Cisis, H → Hisis).
...
Neither the number, nor the quality of an interval can be determined by counting semitones alone because the tonal distance between staff positions is not always a semitone. As explained above, the number of staff positions must be taken into account as well.

For example there are four semitones between A♭ and B♯, between A and C♯, between A and D♭, and between A♯ and E♭♭ (double flat), but:

    • A♭ - B♯ is a second, because it encompasses two staff positions (A, B), and it is doubly augmented, as it exceeds a major second (such as A–B) by two semitones.
    • A - C♯ is a third, because it encompasses three staff positions (A, B, C), and it is major, as it spans 4 semitones.
    • A - D♭ is a fourth, because it encompasses four staff positions (A, B, C, D), and it is diminished, as it falls short of a perfect fourth (such as A-D) by one semitone.
    • A♯ - E♭♭ flat is a fifth, because it encompasses five staff positions (A, B, C, D, E), and it is triply diminished, as it falls short of a perfect fifth (such as A-E) by three semitones.

There is a one-to-one correspondence between staff positions and diatonic-scale degrees (the notes of diatonic scale). This means that interval numbers can also be determined by counting diatonic scale degrees, rather than staff positions, provided that the two notes that form the interval are drawn from a diatonic scale. Namely, C–G is a fifth because in any diatonic scale that contains C and G, the sequence from C to G includes five notes. For instance, in the A♭-major diatonic scale, the five notes are C–D♭–E♭–F–G. This is not true for all kinds of scales. For instance, in a chromatic scale, there are eight notes from C to G (C–C♯–D–D♯–E–F–F♯–G). This is the reason interval numbers are also called diatonic numbers, and this convention is called diatonic numbering.

Die Intervallnummer kommt aus wie viel Notenlinien ein Intervall umfasst. Zum Beispiel C → G ist eine Quinte (Notenlinien: C, D, E, F, G), und E♭ → F ist eine Sekunde (Notenlinien E, F). Der Type von eine Intervall kommt aus wie viel Halbtöne liegt darin. C → G ist 7 Halbtöne, und E♭ → F ist 3 Halbtöne. 7 Halbtöne ist eine Quinte. 3 Halbtöne ist eine kleine Terz.
...
Any note which is exactly twelve semitones higher or lower is an octave or perfect octave. For example C♮ -> C♮ or E♭ -> E♭ where the 2nd note is in a different octave (+/- 1200 cents in 12-TET) to the first note.

Chromatic Semitone / Augmented Unison / Augmented Prime (Minor Second)
...
In a diatonic scale such as C-Major, starting from C as the first note, the second note is D. D is a whole tone higher than C so here the interval is a Major Second.
...
Fourths follow similar logic and are always a perfect fourth or an augmented fourth. In C-Major all fourths are perfect fourths (such as C -> F) meaning they are 5 semitones apart,  except for one fourth (F -> B) which is six semitones apart and is an augmented fourth.

Fifth / Die Quinte

Fifths follow similar logic and are always a perfect fifth or a diminished fifth. In C-Major all fifths are perfect fifths (such as C -> G) meaning they are 7 semitones apart,  except for one fifth (B -> F) which is six semitones apart and is a diminished fifth.

Sixth / Die Sexte

Sixths follow similar logic and are always a major sixth or a minor sixth.

Seventh / Die Septime

Sevenths follow similar logic and are always a major seventh or a minor seventh.


Interval Quality
Interval Names

The name of an interval is qualified using the terms perfect (P), major (M), minor (m), augmented (A), and diminished (d). This is called its interval quality. It is possible to have doubly diminished and doubly augmented intervals, but these are quite rare, as they occur only in chromatic contexts.
...
Perfect intervals are so-called because they were traditionally considered perfectly consonant, although in Western classical music the perfect fourth was sometimes regarded as a less than perfect consonance. Conversely; minor, major, augmented, or diminished intervals are typically considered less consonant, and were traditionally classified as mediocre consonances, imperfect consonances, or dissonances.

Within a diatonic scale all unisons and octaves are perfect (designated with P1 and P8 respectively). Most fourths (five semitones) and fifths (seven semitones) are also perfect (designated as P4 and P5 respectively). 

One occurrence of a fourth is augmented and not perfect (designated as A4) and one occurrence of a fifth is diminished and not perfect (designated as d5). Both of these non-perfect intervals span six semitones. For example, in the C-major scale, the A4 is between F and B, and the d5 is between B and F.

Major and Minor Intervals

A diatonic scale defines seven intervals for each interval number, each starting from a different note in the scale (seven unisons, seven seconds, seven thirds, and so on). Refer to the Reference Diagram. There are seven seconds in the C-major diatonic scale (C -> D, D -> E, E -> F, and so on), there are seven fifths (G -> D, A -> E, B -> F, and so on), etc. For each of the seven instances of each interval type, some are major and some are minor. For example, C -> D is a major second but E -> F is a minor second.

The intervals formed by the notes of a diatonic scale are called diatonic. Except for unisons and octaves, the diatonic intervals with a given interval number always occur in two sizes, which differ by one semitone. For example, six of the fifths span seven semitones. The other one spans six semitones. Four of the thirds span three semitones, the others four. If one of the two versions is a perfect interval, the other is called either diminished (i.e. narrowed by one semitone) or augmented (i.e. widened by one semitone). Otherwise, the larger version is called major, the smaller one minor. For instance, since a 7-semitone fifth is a perfect interval (P5), the 6-semitone fifth is called a "diminished fifth" (d5). Conversely, since neither kind of third is perfect, the larger one is called "major third" (M3), the smaller one "minor third" (m3).
...
By definition, the inversion of a perfect interval is also perfect (the inversion of a perfect fourth is a perfect fifth and the inversion of a perfect fifth is a perfect fourth). Since the inversion does not change the pitch class of the two notes, it hardly affects their level of consonance (matching of their harmonics). For example, in the C-major scale a perfect fifth P5 is C -> G, and G -> C if a perfect fourth P4.

Conversely, other kinds of intervals have the opposite quality with respect to their inversion. The inversion of a major interval is a minor interval, and the inversion of a minor interval is a major interval. Similarly the inversion of an augmented interval is a diminished interval, and the inversion of a diminished interval is an augmented interval.
...
Notes in A minor:  A   B   C   D   E   F        Ab   A
Interval positions:  1,  2,  ♭3,  4,  5,  ♭6,      7,    8
Interval sequence:   T   S    T   T   S    T+S    S
...
The melodic minor scale is formed by using the raised sixth in the ascending form of the scale, but a lowered seventh in the descending form of the scale.

Ascending notes in A minor:
Ascending positions: 1, 2, ♭3, 4, 5, 6, 7, 8
Ascending interval sequence: T, S, T, T, T, T, S
...
Key Signature / Das Vorzeichen.

https://de.wikipedia.org/wiki/Vorzeichen_(Musik)#Tonarten_und_alterierte_T%C3%B6ne
...
7, an incomplete dominant seventh chord.

Functional harmony tends to rely heavily on the primary triads: triads built on the tonic, subdominant, and dominant degrees.[8] The roots of these triads are the first, fourth, and fifth degrees (respectively) of the diatonic scale, and the triads are accordingly symbolised I, IV, and V. Primary triads "express function clearly and unambiguously." The other triads in diatonic keys include the supertonic, mediant, submediant, and subtonic, whose roots are the second, third, sixth, and seventh degrees (respectively) of the diatonic scale, symbolised ii, iii, vi, and viio. They function as auxiliary or supportive triads to the primary triads.


Triads
A common triad chord can be regarded as consisting of a "stack" of three notes; a root note plus two consecutive thirds, on top of the root. This allows for four permutations, each producing a chord with distinct quality:
Root Note	1st Third	2nd Third	Resulting
Chord Quality
Root - 1
C	Major - 3
E	Minor - 5
...
The chords that make up major and minor scales are all built from major and minor thirds due to the use of Tertian Harmony.
The triad's members, from lowest-pitched tone to highest, are called:
    1. The root (inversion does not change the root, the third or fifth can be the lowest note).
    2. The third - its interval above the root being a minor third (three semitones) or a major third (four semitones).
    3. The fifth - its interval above the third being a minor third or a major third, hence its interval above the root being a diminished fifth (six semitones), perfect fifth (seven semitones), or augmented fifth (eight semitones), (perfect fifths are the most commonly used interval above the root in Western classical, popular and traditional music).
...
A diatonic chord is a chord made up entirely of the naturally occurring notes of a particular key. In the scale of Cmaj for example, the diatonic triads moving up the scale are:
...
Lines on the treble clef staff: Every Good Boy Deserves Football.

Spaces in the treble clef staff: FACE

Lines on the bass clef staff: Grizzly Bears Don't Fly Airplanes

Spaces in the bass clef staff: All Cows Eat Grass
